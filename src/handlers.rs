...
pub fn create_buttons(grid: &gtk::Grid, entry: &gtk::Entry) {
    let buttons = [
        ("sin", 1, 1, 0, 1), ("cos", 1, 1, 1, 1), ("tang", 1, 1, 2, 1),("",1,1,3,1),
        ("csc", 1, 1, 0, 2), ("sec", 1, 1, 1, 2), ("cot", 1, 1, 2, 2),("",1,1,3,2),
        ("ln", 1, 1, 0, 3),("log", 1, 1, 1, 3),("C", 1, 1, 2, 3),("⏻", 1, 1, 3, 3),
        ("^", 1, 1, 0, 4),("(", 1, 1, 1, 4),(")", 1, 1, 2, 4),("/", 1, 1, 3, 4),
...
pub fn style_button(button: &gtk::Button, label: &str) {
    if ["/", "x", "-", "+", "=", "(", ")", "^", "ln", "log", "sin", "cos", "tang", "csc", "sec", "cot"].contains(&label) {
